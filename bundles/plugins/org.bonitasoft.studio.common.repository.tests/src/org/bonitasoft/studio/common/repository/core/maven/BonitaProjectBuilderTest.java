...
class BonitaProjectBuilderTest {
    ...
    @Test
    void should_report_error_when_runtime_version_is_another_major_version() throws Exception {
        var validator = new BonitaProjectBuilder.BonitaRuntimeVersionValidator();
    ...
    @Test
    void should_be_ok_when_runtime_version_perfeclty_match() throws Exception {
        var validator = new BonitaProjectBuilder.BonitaRuntimeVersionValidator();
