...
public class OpenH2ConsoleHandlerTest {
    ...
    public void should_throw_FileNotFoundException_if_h2_jar_is_missing() throws Exception {
        doReturn(new File(URLDecoder.decode(FileLocator.toFileURL(OpenH2ConsoleHandlerTest.class.getResource("/workspaceWithoutH2")).getFile(),
                "UTF-8")))
    ...
    public void should_build_java_command() throws Exception {
        ...
        assertThat(captor.getValue()).contains("-jar \"h2.jar\" -browser -webPort",
                "-tcp -user sa -url \"jdbc:h2:file:/test/h2_db/business_data.db;DB_CLOSE_ON_EXIT=TRUE;IGNORECASE=TRUE;AUTO_SERVER=TRUE;\" -driver org.h2.Driver");
